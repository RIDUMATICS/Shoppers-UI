<template>
  <div class="rating" @mouseover="hoverRating" @mouseleave="removeRating">
    ...
    <div class="outer-rating" ref="star" :style="{ width: rating}">
        <font-awesome-icon class="icon" :icon="faStar" @click="selectRating(1)" data-star="1"/>
        <font-awesome-icon class="icon" :icon="faStar" @click="selectRating(2)" data-star="2"/>
        <font-awesome-icon class="icon" :icon="faStar" @click="selectRating(3)" data-star="3"/>
        <font-awesome-icon class="icon" :icon="faStar" @click="selectRating(4)" data-star="4"/>
        <font-awesome-icon class="icon" :icon="faStar" @click="selectRating(5)" data-star="5"/>
    </div>
  </div>
</template>
