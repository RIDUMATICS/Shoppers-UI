<template>
  <div id="alert" :class="{'error': message.status == 'error', 'success': message.status == 'success','show': toggleAlert}">
    <div>
      <p>{{ message.head }}</p>
...
<style>
  ...
  #alert {
    ...
    transition: 300ms cubic-bezier(.25,.25,.75,.75) all;
  }
  #alert .icon {
    color: #fff;
    cursor: pointer;
