  ...
  <main>
    <section class="order container">
        ...
        <table class="table-shopping-order">
          <tbody>
            <tr class="table_head">
              ...
              <th class="column-4">COUNT IN STOCK</th>
            ...
            <tr v-for="product in products" :key="product.id" class="table_row">
              ...
              <td class="column-4">{{ product.countInStock }}</td>
              <td class="column-5">
                <router-link
                  class="btn-1"
                  :to="{
                  ...
                  >Edit</router-link
                >
                <button class="btn-2" @click="deleteProduct(product.id)">
                  Delete
                </button>
              </td>
            </tr>
      ...
      <EmptyPage
        ...
        text="unfortunately nothing could be found"
        v-else
      >
