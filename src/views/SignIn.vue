        ...
        <div>
          <div class="login_part_text">
            <div class="login_part_text_inner">
              ...
              <router-link :to="{ name: 'register' }" class="color-white"
...
.login_part_form input[type='password'],
.login_part_form input[type='text'] {
...
.login_part_form input[type='password']:focus {
